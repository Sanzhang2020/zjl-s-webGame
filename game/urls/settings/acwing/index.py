...
urlpatterns = [
    ...
    path("web/apply_code/", acapp_apply_code, name = "settings_acwing_acapp_apply_code"),
    path("web/receive_code/", acapp_receive_code, name = "settings_acwing_acapp_receive_code"),
]